...
in this projects I deal with some major and typical models for recommender systems.

I take the exemple of a VOD webplatform like YouTube which wants to improve its sales by recommending more relevant movies to its customers.
It can also be a streaming platform like Netflix which wants to build customer loyalty and retention.

What recommeder systems can solve ?
